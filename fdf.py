...
This module supports data access at the HSX stellarator.  HSX uses the "fast data format," originally written by Paul Probert, for storing its data. It is a binary C-format.

Originally written by Jerahmie Radder (github.com:jerahmie/pyfdf.git)
Forked into the IO module and editted by G.M. Weir
